...
;  ld hl, 0x0409
;  ld bc, 0xbc00
;  out (c), h: inc b : out (c), c : dec b
;  out (c), l : inc b : out (c), c
...
.build_texture
 ...
 ld de, 0*256 + OCTET_ENCRE1 :  call build_texture_line
 ld de, OCTET_ENCRE1*256 + 0 :  call build_texture_line
 ...
 ld de, 0x4000 : push de : ld hl, bndlogo_patch : ld c, OCTET_ENCRE2 : call patch_texture
 ld de, 0x4000 + 256*16 + 16 :  ld hl, bndlogo_patch :  ld c, OCTET_ENCRE2 : call patch_texture
